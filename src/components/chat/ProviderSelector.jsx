// ProviderSelector component extracted from ChatInterface.jsx
// Displays the empty state UI when no messages exist - provider buttons, model selection, NextTaskBanner
...
const ProviderSelector = ({
  provider, setProvider, claudeModel, setClaudeModel, cursorModel, setCursorModel,
  codexModel, setCodexModel, textareaRef, tasksEnabled, isTaskMasterInstalled,
  setInput, onShowAllTasks, selectedSession, currentSessionId
}) => {
